...
class CreateForm extends Form {
    public function initialize() {
        ...
        $status_id->addValidator(new PresenceOf(['message' => 'O campo (Senha) é obrigatório']));
        $this->add($status_id);
        //Criado por usuário
        $created_by_user_id = new Hidden('created_by_user_id', ['value' => 1]);
        $this->add($created_by_user_id);
        //Data de Cadastro
